...
import { View, Text, StyleSheet, Button, ActivityIndicator, Alert, FlatList, TouchableOpacity, Image } from 'react-native';
...
function Dashboards({ navigation }) {
  ...
  }, [currentAuthUserUid, selectedPatientId, userRole, linkedPatients]); // Agregado currentAuthUserUid a dependencias
